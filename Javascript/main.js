 ...
 * =====================================================
 * This file initializes the application. It creates the
 * StateManager, CanvasRenderer, and Controller, and
 * connects them. It also handles the UI logic for the
...
function initializeApp() {
    try {
        ...
        const handleInputChange = () => {
            ...
            // 2. Toggle the direction group visibility
            ...
            // 3. Re-generate the simulation to update the state
